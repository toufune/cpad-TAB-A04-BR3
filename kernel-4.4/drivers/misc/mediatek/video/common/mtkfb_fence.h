...
#include "../mt8167/videox/disp_drv_platform.h"
#include "../mt8167/dispsys/display_recorder.h"
...
unsigned int mtkfb_query_buf_mva(unsigned int session_id, unsigned int layer_id,
				 unsigned int idx);
unsigned long mtkfb_query_buf_va(unsigned int session_id, unsigned int layer_id,
				unsigned int idx);
